...
for i in range(n):
    for j in range(5,10):
        ...
        with open(f"\\\\egr-1l11qd2\\CLS_lab\\Junya Zhao\\Data driven model _paper [June 25_2018\\FeatureSelection\\EvlSearch\\{i}_{j}_Label.csv","w") as fo:
...
for csv in globbed_files:
    ...
    data.class_is_last()
    search = ASSearch(classname="weka.attributeSelection.EvolutionarySearch", options=["-population-size","200","-generations", "500", "-crossover-probability","0.6"])
